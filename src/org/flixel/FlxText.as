package org.flixel
{
	...
	public class FlxText extends FlxSprite
	{
		...
		public function set outline(Color:uint):void
		{
			_outline = Color;
			calcFrame();
		}
		...
		override protected function calcFrame():void
		{
			...
			if((_textField != null) && (_textField.text != null) && (_textField.text.length > 0))
			{
				...
				//Render a stroke outline
				if (_outline > 0)
				{
					_textField.setTextFormat(new TextFormat(formatAdjusted.font,formatAdjusted.size,_outline,null,null,null,null,null,formatAdjusted.align));                
					_matrix.translate(1, 1);
					_pixels.draw(_textField, _matrix, _colorTransform);
